  ...
  return (
    <div className="h-[100vh] flex justify-center items-center   ">
      <div
        ...
        aria-hidden="true"
      >
        <div className="relative left-1/2 -z-10 aspect-[1200/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffbb00] to-[#ffffff] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"></div>
      </div>
      <form
